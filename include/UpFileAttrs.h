...
public:
	...
	INT8 *getFileDownloadPath(){return fileDownloadPath;}
	INT8 *getNewSoftVersion(){return newSoftVersion;}
	UINT32 getNewSoftFileSize(){return newSoftFileSize;}
	INT8 *getFileMD5Code(){return upFileMD5code;}
